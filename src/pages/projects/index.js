...
import soundShine from "images/projects/soundshine01.jpg";
                ...
                <div className={styles.minor}>
                  ...
                  <div className={styles.intro}>
                    ...
                    <div className={styles.desc}>
                      {intro.desc.map((x, key) => {
                        const isLast = intro.desc.length - 1 === key;
                        return (
                          <>
                            {x}
                            {isLast ? "" : <br />}
...
export async function getStaticProps() {
  const selectorData = await [
    "All Project 全部",
    "Brand Domain Design 品牌設計",
    {
      name: "Interior Design 空間設計",
      sub: ["商空設計", "專櫃設計", "餐廳空間", "辦公室設計"],
    },
  ];
